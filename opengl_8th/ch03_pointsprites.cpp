...
void PointSpriteExample::Initialize(const char * title)
{
	...
	data = vtarga::load_targa("sprite.tga", format, width, height);
	...
	{
		{ GL_VERTEX_SHADER, "pointsprites.vs.glsl", 0 },
		{ GL_FRAGMENT_SHADER, "pointsprites.fs.glsl", 0 },
		{ GL_NONE, NULL, 0 }
	};
